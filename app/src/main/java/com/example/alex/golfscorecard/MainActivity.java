package com.example.alex.golfscorecard;
...
public class MainActivity extends ListActivity {
    ...
    private static final String PREFS_FILE = "com.example.alex.golfscorecard.preferences";
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_clear_strokes) {
            mEditor.clear();
            mEditor.apply();
            for(Hole hole : mHoles) hole.setStrokeCount(0);
